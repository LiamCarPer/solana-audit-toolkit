...
#[test]
fn rules_table_declares_sat001_through_sat031() {
    let parsed = export_and_parse(&[]);
    let rules = parsed["runs"][0]["tool"]["driver"]["rules"].as_array().unwrap();
    assert_eq!(rules.len(), 31, "SAT001..SAT031 should all be declared");
    for id in [
        "SAT014", "SAT015", "SAT016", "SAT017", "SAT018", "SAT019", "SAT020", "SAT021", "SAT022", "SAT023", "SAT024",
        "SAT025", "SAT026", "SAT027", "SAT028", "SAT029", "SAT030", "SAT031",
    ] {
